...
LastEditTime: 2024-08-03 18:55:14
FilePath: /src/joy_control/scripts/keyboard_control.py
Description: 叉车键盘控制
...
def draw_interface():
    ...
    # print("max_fork_height: ", max_fork_height)
...
while running and not rospy.is_shutdown():
    ...
    if fork_updated:
        ...
        elif key_status[K_DOWN] and fork_position > -0.40:
            fork_position -= position_step
            fork_position = max(fork_position, -0.40)  # 确保不低于最小值
        ...
        left_fork_pub.publish(fork_position)
        right_fork_pub.publish(fork_position)
    print("fork_position: %.2f", fork_position)
    draw_interface()
