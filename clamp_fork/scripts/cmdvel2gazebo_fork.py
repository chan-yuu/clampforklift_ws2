...
#         self.pub_steerL = rospy.Publisher('/front_left_steering_position_controller/command', Float64, queue_size=1)
#         self.pub_steerR = rospy.Publisher('/front_right_steering_position_controller/command', Float64, queue_size=1)
#         self.pub_rearL = rospy.Publisher('/rear_left_velocity_controller/command', Float64, queue_size=1)
#         self.pub_rearR = rospy.Publisher('/rear_right_velocity_controller/command', Float64, queue_size=1)
    ...
    def publish(self):
        ...
        if self.z != 0:
            ...
            # print("msgSteerL.data", msgSteerL.data)
            # print("msgSteerR.data", msgSteerR.data)
            # print("msgFrontL.data", msgFrontL.data)
            # print("msgFrontR.data", msgFrontR.data)
