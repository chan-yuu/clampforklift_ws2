...
private:
    ...
    ros::Publisher ipc_state_pub_, twist_pub_, gear_state_pub_, throttle_state_pub_, brake_state_pub_, steering_state_pub_;
    ...
    std_msgs::Float64 soc_state_msg;
    std_msgs::Int8 ipc_msg;
    ...
    int gear_cout;
    bool is_print;
    std_msgs::Int8 eposts_msg;
    ros::Publisher eposts_state_pub;
    ros::Publisher soc_state_pub_;
