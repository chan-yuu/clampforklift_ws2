 ...
 * @LastEditTime: 2024-10-20 19:55:48
 * @FilePath: /src/control/include/control/stanley_control.h
 * @Description: 
 * 
...
public:
    ...
    // 轨迹跟踪函数
    double computeSteeringAngle(double yaw_error, double cross_track_error,double current_speed_,double curvature, double current_steering_, double kp_from_control);  // 跟踪路径函数
