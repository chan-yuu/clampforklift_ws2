 ...
 * @LastEditTime: 2024-07-30 04:51:14
 * @FilePath: /CM13_Forklift2024/home/cyun/forklift_sim_ws/src/SC-LeGO-LOAM/SC-LeGO-LOAM/LeGO-LOAM/src/transformFusion.cpp
 * @Description: 
 * 
...
public:
    ...
    TransformFusion(){
        ...
        laserOdometry2.child_frame_id = "camera_est";

        laserOdometryTrans2.frame_id_ = "camera_init";
        laserOdometryTrans2.child_frame_id_ = "camera_est";

        map_2_camera_init_Trans.frame_id_ = "map";
        map_2_camera_init_Trans.child_frame_id_ = "camera_init";

        camera_2_base_link_Trans.frame_id_ = "camera_est";
        camera_2_base_link_Trans.child_frame_id_ = "base_link_est";
