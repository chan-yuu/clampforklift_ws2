 ...
 * @LastEditTime: 2024-07-30 03:33:14
 * @FilePath: /CM13_Forklift2024/home/cyun/forklift_sim_ws/src/SC-LeGO-LOAM/SC-LeGO-LOAM/LeGO-LOAM/src/featureAssociation.cpp
 * @Description: 
 * 
...
public:
    ...
    void publishCloud()
    {
	    ...
	    if (pubCornerPointsSharp.getNumSubscribers() != 0){
	        ...
	        laserCloudOutMsg.header.frame_id = "camera_est";
    ...
    void checkSystemInitialization(){
        ...
        laserCloudCornerLast2.header.frame_id = "camera_est";
        pubLaserCloudCornerLast.publish(laserCloudCornerLast2);

        sensor_msgs::PointCloud2 laserCloudSurfLast2;
        pcl::toROSMsg(*laserCloudSurfLast, laserCloudSurfLast2);
        laserCloudSurfLast2.header.stamp = cloudHeader.stamp;
        laserCloudSurfLast2.header.frame_id = "camera_est";
    ...
    void publishCloudsLast(){
        ...
        if (frameCount >= skipFrameNum + 1) {
            ...
            outlierCloudLast2.header.frame_id = "camera_est";
