...
LastEditTime: 2025-01-12 15:43:41
FilePath: /undefined/home/cyun/forklift_sim_ws3/src/smach_fork/scripts/task_smach_custom.py
...
def main():
    ...
    choose_fsm = rospy.get_param('choose_fsm', False)
    ...
    if (choose_fsm):
        ...
        from smach_sim_tasks_custom import create_state_machine
