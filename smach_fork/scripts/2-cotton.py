...
def create_state_machine():
    ...
    with sm:
        ...
        smach.StateMachine.add('AdjustHeading1', AdjustHeading(goal='observer_point', steering_angle=adjust_steering_angle, changeYawangle=0, gear=1, throttle=0.5, control_com=8),transitions={'finish': 'WidthClose1'})

        smach.StateMachine.add('WidthClose1', SetWidth(clamping_width), transitions={'finish': 'HeightRaiseFinal1'})
        smach.StateMachine.add('HeightRaiseFinal1', SetHeight(height_between_two_cargos + 1, updown_mode=2), transitions={'finish': 'AdjustHeading2'})

        smach.StateMachine.add('AdjustHeading2', AdjustHeading(goal='observer_point', steering_angle=adjust_steering_angle, changeYawangle=0, gear=1, throttle=0.5, control_com=8),transitions={'finish': 'FINISH'})
